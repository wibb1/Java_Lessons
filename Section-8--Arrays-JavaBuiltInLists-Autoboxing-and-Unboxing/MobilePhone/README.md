...
    -  A constructor that takes a String (the phone number) and initializes myNumber and instantiates myContacts.
...
    -  A constructor that takes two Strings, and initializes name and phoneNumber.
